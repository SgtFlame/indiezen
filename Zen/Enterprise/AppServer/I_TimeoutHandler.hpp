...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_APPSERVER_I_TIMEOUT_HANDLER_HPP_INCLUDED
#define ZEN_APPSERVER_I_TIMEOUT_HANDLER_HPP_INCLUDED
...
class APPSERVER_DLL_LINK I_TimeoutHandler
:   boost::noncopyable
{
    /// @name Types
    /// @{
public:
    ...
    /// @name I_TimeoutHandler interface.
    /// @{
public:
    /// Handle the timeout
...
#endif // ZEN_APPSERVER_I_TIMEOUT_HANDLER_HPP_INCLUDED
