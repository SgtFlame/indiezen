...
//-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~-~
#ifndef ZEN_ZPOSTGRES_DATABASE_COLUMN_HPP_INCLUDED
#define ZEN_ZPOSTGRES_DATABASE_COLUMN_HPP_INCLUDED
...
public:
    ...
    /// @{
public:
             DatabaseColumn(const std::string& _fieldName, int _fieldType);
...
#endif // ZEN_ZPOSTGRES_DATABASE_COLUMN_HPP_INCLUDED
